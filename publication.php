<?php
	...
	if (isset($_POST["publication"])){
		$test = inserer_nouvel_evenement($CONNECTION,$_POST["titre"],0,$_POST["texte"],$_SESSION["surnom"],$_POST["prive"],$_FILES);
		if ($test){
...
<form class="formulaire1" method="post" action="publication.php" enctype="multipart/form-data">
	
	<h1 class="text_centre">Publiez votre événement !</h1>
